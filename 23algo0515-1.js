...
function findByIdAndUpdate(id, updatedVals, collection) {
    ...
    for (var x = 0; x < collection.length; x++) {
        if (id == collection[x].id) {s
            for (keys in updatedVals) {
                if (keys in collection[x]) {
                    collection[x][keys] = updatedVals[keys]
                }
            }
            return collection[x];
        }
...
console.log("Answer: ", findByIdAndUpdate(id1, updateData1, students), "Expected Answer: ", expected1)
console.log("Answer: ", findByIdAndUpdate(id2, updateData2, students), "Expected Answer: ", expected2)
console.log("Answer: ", findByIdAndUpdate(id3, updateData3, students), "Expected Answer: ", expected3)